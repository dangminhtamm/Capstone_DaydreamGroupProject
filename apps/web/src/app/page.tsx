      ...
      <main className="mx-auto max-w-5xl px-6 py-20">
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm">
            ...
            <h3 className="text-lg font-semibold text-slate-900">AI Search</h3>
            <p className="mt-2 text-slate-600">Ask questions about your past entries and get intelligent, cited answers.</p>
          </div>
        </div>
      </main>
    </div>
