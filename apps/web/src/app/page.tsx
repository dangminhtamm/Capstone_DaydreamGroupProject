          ...
          <div className="flex items-center gap-3">
            ...
            {isLoading ? (
              ...
              <button
                ...
                className="flex cursor-pointer items-center gap-2 px-4 py-2 bg-slate-900 text-white text-sm font-medium rounded-lg hover:bg-slate-800 transition-colors dark:bg-indigo-600 dark:hover:bg-indigo-500"
              >
                Sign in with Google
              </button>
            )}
